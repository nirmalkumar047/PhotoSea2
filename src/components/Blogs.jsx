    ...
    <div className='p-10'>
        ...
        <div className='border border-blue-300 rounded-[15px] p-5 hover:text-blue-300'>
            ...
            <div className='flex flex-col md:flex-row'>
                ...
                <img src="src/assets/Blogs/concept.jpg" className='h-auto md:h-[400px] rounded-[25px] w-full md:w-auto' />
            </div>
        </div>
        <div className='border border-blue-300 rounded-[15px] p-5 hover:text-blue-300'>
            ...
            <div className='flex flex-col md:flex-row'>
                <img src="src/assets/Blogs/astro.jpg" className='h-auto md:h-[400px] rounded-[25px] w-full md:w-auto' />
        ...
        <div className='border border-blue-300 rounded-[15px] p-5 hover:text-blue-300'>
            ...
            <div className='flex flex-col md:flex-row'>
                ...
                <img src="src/assets/Blogs/drone.jpg" className='h-auto md:h-[400px] rounded-[25px] w-full md:w-auto' />
            </div>
        </div>
        <div className='border border-blue-300 rounded-[15px] p-5 hover:text-blue-300'>
            ...
            <div className='flex flex-col md:flex-row'>
                <img src="src/assets/Blogs/spect.jpg" className='h-auto md:h-[400px] rounded-[25px] w-full md:w-auto' />
        ...
        <div className='border border-blue-300 rounded-[15px] p-5 hover:text-blue-300'>
            ...
            <div className='flex flex-col md:flex-row'>
                ...
                <img src="src/assets/Blogs/still-life.jpg" className='h-auto md:h-[400px] rounded-[25px] w-full md:w-auto' />
            </div>
        </div>
        <div className='border border-blue-300 rounded-[15px] p-5 hover:text-blue-300'>
            ...
            <div className='flex flex-col md:flex-row'>
                <img src="src/assets/Blogs/mono.jpg" className='h-auto md:h-[400px] rounded-[25px] w-full md:w-auto' />
